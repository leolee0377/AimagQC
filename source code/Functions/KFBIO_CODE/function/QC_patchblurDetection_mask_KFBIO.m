function blockorg = QC_patchblurDetection_mask_KFBIO(IMAGE_PTR,bs,PageIndex,OutputPath,slideID,MASK,ImageType,KFBname)
...
%     IMAGE_PTR
[bool, datalength] = calllib('lib','GetImageStreamSize',IMAGE_PTR,PageIndex,Coord(2),Coord(1),0);
pBuffer = libpointer('uint8Ptr',zeros(datalength,1));
[bool, pBuffer] = calllib('lib','GetImageStreamBySize',IMAGE_PTR,PageIndex,Coord(2),Coord(1),datalength,pBuffer);
